...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	if (nrhs != 23) {
		mexErrMsgTxt("Twenty-three input arguments are required.");
	}
	...
	const double iord = (double) mxGetScalar(prhs[6]);
	const double *mediumDimensionsd = (double *) mxGetPr(prhs[7]);

	/* Input source parameters. */
	const double *lightOrigind = (double *) mxGetPr(prhs[8]);
	const double *lightDird = (double *) mxGetPr(prhs[9]);
	const double *lightPlaned = (double *) mxGetPr(prhs[10]);
	...
	const double *viewXd = (double *) mxGetPr(prhs[14]);
	const double *viewYd = (double *) mxGetPr(prhs[15]);
	const double *viewPlaned = (double *) mxGetPr(prhs[16]);
	const double *pathlengthRanged = (double *) mxGetPr(prhs[17]);
	const double *viewResod = (double *) mxGetPr(prhs[18]);

	/* Input rendering parameters. */
	const double numPhotonsd = (double) mxGetScalar(prhs[19]);
	const double maxDepthd = (double) mxGetScalar(prhs[20]);
	const double maxPathlengthd = (double) mxGetScalar(prhs[21]);
	const double useDirectd = (double) mxGetScalar(prhs[22]);
