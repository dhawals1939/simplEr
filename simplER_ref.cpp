...
//     AnyMap dict = convertJsonToMap(j);

//     // --- Access some known fields ---
//     try
//     {
//         std::string name = std::any_cast<std::string>(dict["name"]);
//         int age = std::any_cast<int>(dict["age"]);
//         double height = std::any_cast<double>(dict["height"]);
//         bool active = std::any_cast<bool>(dict["active"]);

//         auto tags_any = std::any_cast<std::vector<std::any>>(dict["tags"]);
//         std::string first_tag = std::any_cast<std::string>(tags_any[0]);

//         auto settings = std::any_cast<AnyMap>(dict["settings"]);
//         auto resolution = std::any_cast<std::vector<std::any>>(settings["resolution"]);
//         int width = std::any_cast<int>(resolution[0]);
//         int height_px = std::any_cast<int>(resolution[1]);

//         std::cout << "Name: " << name << "\n";
//         std::cout << "Age: " << age << ", Height: " << height << "\n";
//         std::cout << "Active: " << std::boolalpha << active << "\n";
//         std::cout << "First tag: " << first_tag << "\n";
//         std::cout << "Resolution: " << width << "x" << height_px << "\n";
//     }
...
int main(int argc, char **argv)
{
    ...
    fmt::print("simplER renderer started with {} arguments\n", argc);
    ...
    if (stricts)
    {
        if (!bthreads)
        {
            std::cout << "threads is not specified " << std::endl;
        }
        if (!bprecision)
        {
            std::cout << "precision is not specified " << std::endl;
        }
        if (!bnumPhotons)
        {
            std::cout << "numPhotons is not specified " << std::endl;
        }
        if (!boutFilePrefix)
        {
            std::cout << "outFilePrefix is not specified " << std::endl;
        }
        if (!bsigmaT)
        {
            std::cout << "sigmaT is not specified " << std::endl;
        }
        if (!balbedo)
        {
            std::cout << "albedo is not specified " << std::endl;
        }
        if (!bgVal)
        {
            std::cout << "gVal is not specified " << std::endl;
        }
#if USE_RIF_FUS
        if (!bf_u)
        {
            std::cout << "f_u is not specified " << std::endl;
        }
        if (!bspeed_u)
        {
            std::cout << "speed_u is not specified " << std::endl;
        }
        if (!bn_o)
        {
            std::cout << "n_o is not specified " << std::endl;
        }
        if (!bn_scaling)
        {
            std::cout << "n_scaling is not specified " << std::endl;
        }
        if (!bn_coeff)
        {
            std::cout << "n_coeff is not specified " << std::endl;
        }
        if (!bradius)
        {
            std::cout << "radius is not specified " << std::endl;
        }
        if (!bcenter1)
        {
            std::cout << "center1 is not specified " << std::endl;
        }
        if (!bcenter2)
        {
            std::cout << "center2 is not specified " << std::endl;
        }
        if (!bactive1)
        {
            std::cout << "active1 is not specified " << std::endl;
        }
        if (!bactive2)
        {
            std::cout << "active2 is not specified " << std::endl;
        }
        if (!bphase1)
        {
            std::cout << "phase1 is not specified " << std::endl;
        }
        if (!bphase2)
        {
            std::cout << "phase2 is not specified " << std::endl;
        }
        if (!bchordlength)
        {
            std::cout << "chordlength is not specified " << std::endl;
        }
        if (!btheta_sources)
        {
            std::cout << "theta_sources is not specified " << std::endl;
        }
        if (!btrans_z_sources)
        {
            std::cout << "trans_z_sources is not specified " << std::endl;
        }
#else
        if (!bf_u)
        {
        ...
        if (!bn_max)
        {
            std::cout << "n_max is not specified " << std::endl;
        }
        if (!bn_clip)
        {
            std::cout << "n_clip is not specified " << std::endl;
        }
        if (!bphi_min)
        {
            std::cout << "phi_min is not specified " << std::endl;
        }
        if (!bphi_max)
        {
            std::cout << "phi_max is not specified " << std::endl;
        }
        if (!bmode)
        {
        ...
        if (!bemitter_gap)
        {
            std::cout << "emitter_gap is not specified " << std::endl;
        }
        if (!bsensor_gap)
        {
            std::cout << "sensor_gap is not specified " << std::endl;
        }
        if (!ber_stepsize)
        {
            std::cout << "er_stepsize is not specified " << std::endl;
        }
        if (!buseInitializationHack)
        {
            std::cout << "useInitializationHack is not specified " << std::endl;
        }
        if (!bdirectTol)
        {
            std::cout << "directTol is not specified " << std::endl;
        }
        if (!brrWeight)
        {
            std::cout << "rrWeight is not specified " << std::endl;
        }
        if (!bprojectorTexture)
        {
            std::cout << "projectorTexture is not specified " << std::endl;
        }
        if (!buseDirect)
        {
            std::cout << "useDirect is not specified " << std::endl;
        }
        if (!buseAngularSampling)
        {
            std::cout << "useAngularSampling is not specified " << std::endl;
        }
        if (!buseBounceDecomposition)
        {
            std::cout << "useBounceDecomposition is not specified " << std::endl;
        }
        if (!bmaxDepth)
        {
            std::cout << "maxDepth is not specified " << std::endl;
        }
        if (!bmaxPathlength)
        {
            std::cout << "maxPathlength is not specified " << std::endl;
        }
        if (!bpathLengthMin)
        {
            std::cout << "pathLengthMin is not specified " << std::endl;
        }
        if (!bpathLengthMax)
        {
            std::cout << "pathLengthMax is not specified " << std::endl;
        }
        if (!bpathLengthBins)
        {
            std::cout << "pathLengthBins is not specified " << std::endl;
        }
        if (!bspatialX)
        {
            std::cout << "spatialX is not specified " << std::endl;
        }
        if (!bspatialY)
        {
            std::cout << "spatialY is not specified " << std::endl;
        }
        if (!bhalfThetaLimit)
        {
            std::cout << "halfThetaLimit is not specified " << std::endl;
        }
        if (!bemitter_size)
        {
            std::cout << "emitter_size is not specified " << std::endl;
        }
        if (!bsensor_size)
        {
            std::cout << "sensor_size is not specified " << std::endl;
        }
        if (!bmediumLx)
        {
            std::cout << "mediumLx is not specified " << std::endl;
        }
        if (!bmediumRx)
        {
            std::cout << "mediumRx is not specified " << std::endl;
        }
        if (!bdistribution)
        {
            std::cout << "distribution is not specified " << std::endl;
        }
        if (!bgOrKappa)
        {
            std::cout << "gOrKappa is not specified " << std::endl;
        }
        if (!bemitter_distance)
        {
            std::cout << "emitter_distance is not specified " << std::endl;
        }
        if (!bemitter_lens_aperture)
        {
            std::cout << "emitter_lens_aperture is not specified " << std::endl;
        }
        if (!bemitter_lens_focalLength)
        {
            std::cout << "emitter_lens_focalLength is not specified " << std::endl;
        }
        if (!bemitter_lens_active)
        {
            std::cout << "emitter_lens_active is not specified " << std::endl;
        }
        if (!bsensor_distance)
        {
            std::cout << "sensor_distance is not specified " << std::endl;
        }
        if (!bsensor_lens_aperture)
        {
            std::cout << "sensor_lens_aperture is not specified " << std::endl;
        }
        if (!bsensor_lens_focalLength)
        {
            std::cout << "sensor_lens_focalLength is not specified " << std::endl;
        }
        if (!bsensor_lens_active)
        {
            std::cout << "sensor_lens_active is not specified " << std::endl;
        }
#if USE_RIF_SPLINE
        if (!brifgridFile)
        {
            std::cout << "rifgridFile is not specified " << std::endl;
        }
#endif
        if (!bprintInputs)
        {
            std::cout << "printInputs is not specified " << std::endl;
        }
    ...
    // some sanity checks
    {
        ...
        if (bemitter_gap && (emitter_gap < 0 || emitter_gap > (mediumR[0] - mediumL[0])))
        {
            std::cout << "invalid gap between the emitter and the US:" << emitter_gap << std::endl;
            exit(EXIT_FAILURE);
        }
        if (bsensor_gap && (sensor_gap < 0 || sensor_gap > (mediumR[0] - mediumL[0])))
        {
            std::cout << "invalid gap between the sensor and the US:" << sensor_gap << std::endl;
            exit(EXIT_FAILURE);
        }
        if (bemitter_gap && bsensor_gap && ((sensor_gap + emitter_gap) > (mediumR[0] - mediumL[0])))
        {
